...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/super-admin/pelaburan",
    title: "Pelaburan",
    type: "link",
    icontype: "fas fa-hand-holding-usd text-default",
  },
  {
    path: "/super-admin/pengkosan-projek",
    title: "Pengkosan Projek",
    type: "link",
    icontype: "fas fa-tasks text-default",
  },
  {
    path: "/super-admin/sistem-maklumat-pengurusan",
    title: "Sistem Maklumat Pengurusan",
    type: "link",
    icontype: "fas fa-tasks text-default",
  },
  {
    path: "/super-admin/paparan-kewangan",
