...
@Component({
  selector: "app-kill-session",
  templateUrl: "./kill-session.component.html",
  styleUrls: ["./kill-session.component.scss"]
})
export class KillSessionComponent implements OnInit {
  day = [
    "Sunday",
    "Monday",
    "Tuesday",
