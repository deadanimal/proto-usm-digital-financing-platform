...
@Component({
  selector: "app-pentadbir-sistem",
  templateUrl: "./pentadbir-sistem.component.html",
  styleUrls: ["./pentadbir-sistem.component.scss"]
})
export class PentadbirSistemComponent implements OnInit {
  day = [
    "Sunday",
    "Monday",
    "Tuesday",
