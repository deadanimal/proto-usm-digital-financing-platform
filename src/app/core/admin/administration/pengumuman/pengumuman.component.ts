...
import * as Pengumumans from "src/app/variables/administration/pengumumans";
...
export class PengumumanComponent implements OnInit {
  ...
  resetTable() {
    ...
    this.searchInput.announcementmy = "";
    this.searchInput.announcementen = "";
  }
